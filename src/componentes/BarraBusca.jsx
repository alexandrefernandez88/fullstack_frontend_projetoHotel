...
export default function BarraBusca({ placeHolder,
    ...
    function filtrarResultado() {
        ...
        if (dadosLista.length > 0) { componenteResultado.style.display = 'block'; }
        else { componenteResultado.style.display = "none"; }
    }

    return (
        <Container>
            <div className='barra'> {/* lupa */}
                ...
                <Form.Control /* imput */
                    ...
                    onChange={e => {
                        ...
                        filtrarResultado();
                        if (!itemSelecionado) {
                            //                             //esse atributo é utilizado pelo html5 paraverificar se os elementos do formulário estão validos ou não
                ...
                <div className='resultado'>
                    <ul data-resultado>
                        {
                            dadosLista.map(item => {
                                //                             //entidade cliente tem como campo chave o cpf (campoChave=cpf)
